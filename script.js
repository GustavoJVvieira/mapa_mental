...
   
    // Desescapa os <br> generados por nl2br
...
    const centralColor = getComputedStyle(renderedMapData.central.el).backgroundColor; // Cor do Nó Central

    renderedMapData.central.children.forEach(childData => {
        const mainMetrics = getElementMetrics(childData.el);
        const boxColor = getComputedStyle(childData.el).backgroundColor; // Cor do Box Principal (Pai dos Subtópicos)

        // ====================================================================
        // 1. CONEXÃO NÓ CENTRAL -> NÓ FILHO (BOX) - Conexão Lateral Obrigatória com Curva
        // * Aplica a cor do Nó Central como solicitado
        // ====================================================================
...
        // MUDANÇA: Define a cor da linha com base na cor do Nó Central
        line.setAttribute('stroke', centralColor);
        // FIM MUDANÇA
...
        // * Aplica a cor do Box Principal (Filho) como solicitado
        // ====================================================================
        
...
            // MUDANÇA: Define a cor da linha com base na cor do Box Principal (Pai)
            lineN2.setAttribute('stroke', boxColor);
            // FIM MUDANÇA
            
